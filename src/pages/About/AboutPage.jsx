                ...
                <div className='jeffBio'>
                    ...
                    <div className='jeffBioTxt'>
                        ...
                        <div className='jeffBioPtTwoContainer'>
                            <p>Jeff became certified in 2013. Since then he has owned and operated his business of helping impact change in others. He also carries certifications in Nutrition, Sr. Adult Fitness, and Sports Medicine.</p>
                            <p>As for himself, Jeff prefers a variation of training styles. From traditional weight lifting to high intensity training, he finds value in it all. He also finds significance in the mind-body connection. Practices such as yoga and other alternative methods help to make coaching an all encompassing experience.</p>
                        </div>
                        <div className='jeffQuoteContainer'>
                        ...
                        <div className='jeffBioPtThreeContainer'>
                            <p>Jeff has run marathons, gauntlet courses, enjoys hiking, good conversation, and long walks on the... wait, wrong bio...</p>
                            <p>Anyway, if you’re looking for some one to walk boldly with you in the direction you’ve been wanting to go, here’s a teammate.</p>
                        </div>
                    </div>
                </div>
                <br/><br/>
